...
<body>
    ...
    <form action="<%= request.getContextPath() %>/Usuario" method="GET">
        <input type="text" name="searchTerm" placeholder="Buscar por nombre o ID">
    ...
    <div id="userDetails" class="alert alert-success" role="alert" style="<%= usuarioEncontrado != null ? "" : "display: none;" %>">
        <p><strong>ID:</strong> <%= usuarioEncontrado != null ? usuarioEncontrado.getId() : "" %></p>
        <p><strong>Nombre:</strong> <%= usuarioEncontrado != null ? usuarioEncontrado.getNombre() : "" %></p>
        <p><strong>Usuario:</strong> <%= usuarioEncontrado != null ? usuarioEncontrado.getUsuario() : "" %></p>
        <p><strong>Activo:</strong> <%= usuarioEncontrado != null ? usuarioEncontrado.isActivo() : "" %></p>
    </div>
    <table>
        <tr>
            <th>ID</th>
