...
<body>
    ...
    <form action="<%= request.getContextPath() %>/Usuario" method="GET">
        <input type="text" name="searchTerm" placeholder="Buscar por ID o nombre">
        <button type="submit" name="searchType" value="id">Buscar por ID</button>
        <button type="submit" name="searchType" value="nombre">Buscar por nombre</button>
    </form>
    <%-- Verificar si hay un usuario encontrado por ID y mostrar el cuadro de detalles si es el caso --%>
